// Kristen Tse
// Homework 08
// The following program creates a class Polynomial, where each coefficient
// is stored in a singly linked list. The focus of this homework is linked
// lists, operator overloading, copy control, and separate compilation.
